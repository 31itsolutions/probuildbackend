...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="" >Business Statistics</a>
    {{-- <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#">Edit Sub Categories</a>  --}}
                            ...
                            <div class="col-md-12 card mt-1">
                                ...
                                <div class="pack-head">
                                    <h1>View Business Statistics</h1>
                                ...
                                <div class="row">
                                    <div class = "col-md-12">
                                        ...
                                        <div class="anal_head">
                                          ...
                                          <div class="header_li">
                                            <h1 >Impressions <i  data-toggle="tooltip" data-placement="top" title="The number of times a particular page is being viewed"> i </i></h1>
                                            @foreach ($analytical as $count)
                                            <p>{{ $count->views }}</p>
                                            @endforeach
                                          </div>

                                          <div class="header_li  ml-5">
                                            <h1 >Business Clicks <i  data-toggle="tooltip" data-placement="top" title="The number of times a particular business is being Clicked"> i </i></h1>
                                            <p>{{ $click_tl }}</p>

                                          </div>

                                          <div class="header_li  ml-5">
                                            <h1 >Click Through Rate <i  data-toggle="tooltip" data-placement="top" title="clicks ÷ impressions = CTR."> i </i></h1>
                                            <p>{{ $click_through }}%</p>

                                          </div>

                                          <div class="header_li  ml-5">
                                            <h1 >Leads <i  data-toggle="tooltip" data-placement="top" title="A  lead is counted each time a user clicks on the phone, sms or email button on your listing."> i </i></h1>
                                              <p>{{ $lead_tl }}</p>

                                          </div>

                                          <div class="header_li   ml-5">
                                            <h1 >Coversion Rate <i  data-toggle="tooltip" data-placement="top" title="The percentage of people who view your listing and turns into a lead: leads ÷ clicks = CVR"> i </i></h1>
                                            <p>{{ $c_r }}%</p>
                        ...
                        <div class="table_view mt-5 m-1">

                        <table class="table  zero-configuration">
                            <thead>
                              <tr>
                                <th scope="col">#</th>
                                <th scope="col">User Name/Ip</th>
