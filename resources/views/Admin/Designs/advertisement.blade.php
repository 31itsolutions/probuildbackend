...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row">
                        ...
                        <div class = "back-option mt-1">     
                            ...
                            <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('advertisement') }}" >Advertisements Images</a>
                                                                ...
                                                                <div class='row'>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <img class="header-img mx-1 mt-1 rounded"
                                                                            ...
                                                                            src="{{asset('upload_images/advertisement_images/'. $get_add_image_child->add_image)}}">
                                                                    </div>
                                                        ...
                                                        <div class="ml-1 mr-4 mt-1 mb-2">
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <img class="header-img mx-1 mt-1 rounded"
                                                                        width="150px" height="100px"
                                                                        src="{{asset('upload_images/advertisement_images/'. $get_add_image_next_child->add_image_next)}}">
                                                                </div>
