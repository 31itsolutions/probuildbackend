...
@include('Admin.admin_layout.header')
   ...
   <div class = "back-option mt-1">     
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('view_category') }}">Main Categories</a> 
    </h1>
       {{-- <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('vendor_accounts') }}">Vendor Accounts </a> --}}
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary add_bu glow mt-2  md-2 mb-1 r-0">Add Categories</button>
                                </a>
                                </div>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Cataegory Icon</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$item->priority}}</td>
      <td>
        <img class="header-img" width = "50px"  style="background-color:rgb(197, 194, 106); border-radius:50%;"  height = "50px" src="{{asset('upload_images/category_icon/'. $item->category_icon)}}">
      </td>
      <td>
