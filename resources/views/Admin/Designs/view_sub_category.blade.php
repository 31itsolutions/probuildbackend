...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('view_sub_category') }}" >Sub Categories</a>
...
<div class="custom-control custom-switch custom-switch-glow custom-control-inline">
    ...
    <label class="custom-control-label" for="customSwitchGlow{{$key}}">
      ...
      <td class = "action_width">
           ...
           <a class="  action" href="{{ route('edit_sub_category',$item->id ) }}"><i class="fas fa-edit"></i> </a>


       <form method="POST" id="delete-form-{{ $item->id }}"
                                            action="{{ route('delete_sub_category',$item->id) }}"
                                            style="display: none">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
