...
@include('Admin.admin_layout.header')
  ...
  <div class = "back-option mt-1">     
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('view_category') }}">Main Categories</a>
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#">Edit Main Categories</a> 
    </h1>
       {{-- <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('vendor_accounts') }}">Vendor Accounts </a> --}}
        </div>    
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "category" value = "{{$category_update->category}}"  required class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "category_description" value = "{{$category_update->category_description}}"  required   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
                            ...
                            <div class = "col-md-6">
                                     ...
                                     <div class="">
                                        <div class="custom-file">
                                            <input name = "category_icon"  type="file" class="custom-file-input" id="customFile" required>
