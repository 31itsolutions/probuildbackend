...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row">
                        ...
                        <div class = "back-option mt-1">     
                            <h1> <i class="fas fa-home text-light"></i>  <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('admin.home') }}">Home</a>
                                <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('sub_category_home') }}">Categories List</a>
                                <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="">Edit Category </a>
                    ...
                    <form action = "{{route('update_category_home', $category->id)}}" method = "POST" enctype="multipart/form-data">
                     @csrf
                    ...
                    <div class = "m-2">
                                ...
                                <div class="pack-head ">
                                    <h1 class = "text-primary">Update Sub Category </h1>
                                </div>
                        ...
                        <div class = "">
                               ...
                               <input type="file" class="custom-file-input" name = "background_image" id="validatedCustomFile" >
                                  <label class="custom-file-label" for="validatedCustomFile">{{ $category->background_image }}</label>
                                  <small id="emailHelp" class="form-text text-muted">Icon size : 590x351</small>
                              ...
                              <img class="header-img" width = "150px" height = "100px" src="{{asset('upload_images/banner_image/'. $image->login_image)}}">
                               @endif --}}
                        ...
                        <div class = "">
                                ...
                                <div class = "col-sm-12">
                               <div class="custom-file">
                               <input type="file" class="custom-file-input" name = "centered_image" id="validatedCustomFile" >
                                  <label class="custom-file-label" for="validatedCustomFile">{{ $category->centered_image }}</label>
                                  <small id="emailHelp" class="form-text text-muted">Icon size : 55.41x34.63</small>
                               ...
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
                                    ...
                                    {{-- @if($image_check==true)
                               <p class = "mt-2">Current image</p>
                              <img class="header-img" width = "150px" height = "100px" src="{{asset('upload_images/banner_image/'. $image->home_image)}}">
                        ...
                        <div class = "">
                                ...
                                <p>Upload Sub category here</p>

                                <div class = "row">
                                <div class = "col-sm-12">
                             
                                           
                                    <select name="sub_category"  id="inputState"class="form-control" required>

                                        @foreach($category_li as $date)
                                        
                                                <option value="{{$date->id}}">{{$date->sub_category}} </option>

                                         @endforeach
                                       
                                </select>
                                <p>{{ $cate_main->sub_category }}</p>
                               </div>
                               </div>
                                    {{-- @if($image_check==true) --}}
                               {{-- <p class = "mt-2">Current image</p> --}}
                              {{-- <img class="header-img" width = "150px" height = "100px" src="{{asset('upload_images/banner_image/'. $image->vendor_image)}}"> --}}
                        ...
                        <div class = "">
                                ...
                                <div class = "col-sm-12">
                                    <select name="place"  id="inputState"class="form-control" required>
                                        <option selected>{{ $category->place }} </option>
                                    ...
                                    {{-- @if($image_check==true)
                               <p class = "mt-2">Current image</p>
                              <img class="header-img" width = "150px" height = "100px" src="{{asset('upload_images/banner_image/'. $image->customer_image)}}">
                  ...
                  <button class="btn btn-sm btn-primary glow ml-3 mt-md-2 mb-1">Update Now</button>
