...
<br>
                ...
                @endif
                    ...
                    <form action = "{{route('update_edited_advertisement', $item->id)}}" method = "POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class = "delete_add">
                                    <button class="btn btn-sm btn-danger glow text-light r-0 md-2 mb-1">
                                        ...
                                        <form method="POST" id="delete-form-{{ $item->id }}"
                                            action="{{ route('delete_advertisement',$item->id) }}"
                                            style="display: none">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
                            ...
                            <div class="col-sm-6">
                                ...
                                src="{{asset('upload_images/advertisement_images/'. $item->add_image)}}">
