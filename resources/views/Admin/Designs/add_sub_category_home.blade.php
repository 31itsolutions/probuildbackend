...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row">
                        ...
                        <div class = "back-option mt-1">     
                            <h1> <i class="fas fa-home text-light"></i>  <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('admin.home') }}">Home</a>
                                ...
                                <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('create_image') }}" >Banner Images</a>
                    ...
                    <form action = "{{route('add_category_home')}}" method = "POST" enctype="multipart/form-data">
                     @csrf
                  ...
                  <button class="btn btn-sm btn-primary glow ml-3 mt-md-2 mb-1">Add Now</button>
