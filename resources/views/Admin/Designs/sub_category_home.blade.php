...
@include('Admin.admin_layout.header')
   ...
   <div class = "back-option mt-1">     
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('view_category') }}">Add Categories</a> 
    </h1>
       {{-- <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('vendor_accounts') }}">Vendor Accounts </a> --}}
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                                    ...
                                    <a href = "{{ route('add_home_category') }}">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
           ...
           <a class="  action" href="{{ route('edit_home_category',$item->home_id ) }}"><i class="fas fa-edit"></i> </a>


       <form method="POST" id="delete-form-{{ $item->id }}"
                                            action="{{ route('delete_category_home',$item->id) }}"
                                            style="display: none">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
