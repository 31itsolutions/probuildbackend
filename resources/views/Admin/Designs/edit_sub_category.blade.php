...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('sub_category') }}" > Sub Categories</a>
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "sub_category" value = "{{$sub_category->sub_category}}" required  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                                                ...
                                                <div class = "col-md-6">
                                                         ...
                                                         <div class="">
                                                            <div class="custom-file">
                                                                <input name = "sub_category_icon" type="file" required class="custom-file-input" id="customFile">
                                                                <label class="custom-file-label" for="customFile">{{$sub_category->sub_category_icon}}</label>
            
                                                              </div>
                                                                <small id="emailHelp" class="form-text text-muted">Image size : 29.21x24</small>
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "sub_category_description" required value = "{{$sub_category->sub_category_description}}"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                                                ...
                                                {{-- <div class="form-group row"> --}}
                                                        ...
                                                        <label for="inputPassword6"> Category Type</label>
                                                                ...
                                                                <select name="category_type"  id="inputState"class="form-control" required>
                                                                    <option value="{{$category_object->id}}" >{{$category_object->category}}</option>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputPassword6">Priority listing</label>
                                                                ...
                                                                <select name="priority"  id="inputState"class="form-control" required>
