...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('sub_category') }}" >Add Sub Categories</a>
...
{{-- 
 ...
 --}}
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "sub_category"  class="form-control" id="staticEmail" required>
                                    ...
                                    <div class = "col-md-6">
                                             ...
                                             <div class="">
                                                <div class="custom-file">
                                                    <input name = "sub_category_icon" type="file" class="custom-file-input" required id="customFile">
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "sub_category_description"  class="form-control" id="staticEmail" required>
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                            ...
                            <label for="inputPassword6"> Premium</label>
                                    ...
                                    <select  name = "premium"  id="inputState"class="form-control" required>
