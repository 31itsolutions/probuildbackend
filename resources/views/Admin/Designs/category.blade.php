...
@include('Admin.admin_layout.header')
  ...
  <div class = "back-option mt-1">     
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('main_category') }}">Add Main Categories</a> 
    </h1>
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "category"  class="form-control" id="staticEmail" required>
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "category_description"  class="form-control" id="staticEmail" required>
                                 </div>
                                 </div>
                                 </div>
