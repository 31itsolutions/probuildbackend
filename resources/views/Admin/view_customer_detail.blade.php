...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{route('user_accounts')}}" >Users Accounts</a>
        <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >User Account</a>
                             ...
                             <div class="pack-edit ml-2 mt-1">
                                ...
                                <p style = "margin-top:6px;">{{$user_account->name}} {{$user_account->lname}}</p>
                                 ...
                                 <p style = "margin-top:6px; ">{{$user_account->number}}</p>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-4 mt-1 col-form-label">Area</label>
                                 <div class="col-sm-8 ">
                                 <p style = "margin-top:18px; ">{{$user_account->area}}</p>
                                 </div>
                                 </div>
                                   </div>
                              ...
                              <div class = "row mx-2 mt-1">
                                 ...
                                 <div class="col-sm-8">
                                 <p style = "margin-top:6px; ">{{$user_account->province}}</p>
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <p style = "margin-top:6px; ">{{$user_account->country}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
