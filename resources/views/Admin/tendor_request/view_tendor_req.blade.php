...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row">
                            ...
                            <div class = "back-option mt-1">     
                                ...
                                {{-- <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('about_us') }}" >About Us</a> --}}
                                    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('admin_tendor_detail') }}" >Tendor Details</a> 
                                    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >View Tendor Request</a> 
                                </h1>
                                    </div> 


                            <div class="col-md-12 card mt-1  tendor_view">
                                ...
                                <div class="pack-head">
                                    <h1>View Tendor Request Details</h1>
                                    
                                </div>
@foreach ($tendor as $item)

<div class = "cu_tendor_detail">
<h1>Customer Name</h1>
<p>{{$item->cu_name}} {{$item->cu_lname}}</p>
<p>Date of Tendor Posted : {{$item->tendorend}}</p>
</div>

<div class = "tendor_tl">
    <h1>{{$item->tendor_title}}</h1>
<p>{{$item->tendor_description}}</p>
</div>

<div class = "tendor_category">
<div>
    <h1>Tendor Category</h1>
<p>{{$item->category}}</p>
</div>

<div class ="sub_cat_admin">
    <h1>Tender sub category</h1>
<p>{{$item->sub_category}}</p>
</div>
</div>

<div class = "tendor_image">
     <img class="header-img mt-1 mb-1" width = "150px" height = "100px" src="{{env('IMG_URL').'upload_images/tendor_sample_image/'.$item->sample_image}}">
...
@endforeach
<div class = "accepted_tendor_li">
<h1>Who Reacted for this Tendor</h1>

@foreach ($vendor_li as $value)
    <li>{{$value->name}}{{$value->lname}}</li>

    @if (empty($value->name))

    No one accepted this Tendor
