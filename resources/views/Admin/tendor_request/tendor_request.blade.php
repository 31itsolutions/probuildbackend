                            ...
                            <div class="col-md-12 card mt-1">
                                ...
                                <div class="table-">
                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>{{ $item->name }} {{ $item->lname }} </td>
                                             <td>{{ $item->tendor_title }}  </td>
                                            <td>{{ $item->tendorend }}  </td>
                                         
                                                          <td>
                                                      <div class = "tendor_action_ad">

                                               <a class="  " href="{{route('edit_tendor_req',$item->tendorId)}}"><i class="fas fa-edit"></i> </a>

                                           <a href = "{{route('view_tendor_req', $item->tendorId)}}" >
                                        ...
                                        {{ $tendor->links('pagination::bootstrap-4') }}</div>
