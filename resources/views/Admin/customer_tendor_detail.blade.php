...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{route('user_accounts')}}" >Users Accounts</a>
        <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Tendor Details</a>
    </h1>
        </div> 
                            ...
                            <div class="pack-head  ml-2 mt-2">
                                ...
                                <div class = ' date'>
                                <p><span>Date : {{$tendor->tendorend}}</span></p>
                                </div>

                                <a class="edit_tendor " href="{{route('edit_tendor_req',$tendor->tendorId)}}"><i class="fas fa-edit"></i> </a>


                                <form method="POST" id="delete-form-{{ $tendor->tendorId }}"
                                    action="{{ route('delete_tendor',$tendor->tendorId) }}"
                                    style="display: none">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}

                                </form>
                                <a class=" action_tendor" onclick="if (confirm('Are you sure want to delete ?')){
                                    event.preventDefault(); //redirect without loading
                                   document.getElementById('delete-form-{{ $tendor->tendorId }}').submit();
                                   }
                                   else
                                    {
                                      event.preventDefault();
         
                                    } " class=""> <i class="far fa-trash-alt"></i> </i>
                                   </a>
                                ...
                                <div class = "row mx-1">
                                  ...
                                  <label for="staticEmail" class=" col-form-label">Tendor Tittle</label>
                                 <div class="">
                               <p>{{$tendor->tendor_title}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                  ...
                                  <div class="col-sm-12 ">
                                  <div class="form-group ">
                                  <label for="staticEmail" class=" col-form-label">Tendor Description</label>
                                 <div class="">
                         <p>{{$tendor->tendor_description}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                   ...
                                   <div class="form-row mx-2">
                                    <div class="col">
                                        <label for="staticEmail" class=" col-form-label">Tendor Category</label>
                                        <p>{{$tendor->category}}</p>
                                    </div>
                                    <div class="col">
                                        <label for="staticEmail" class=" col-form-label">Tendor sub-category</label>
                                        <p>{{$tendor->sub_category}}</p>
                                    </div>
                                  </div>

                                       <div class="form-row mx-2 mb-1">
                                    <div class="col">
                                   <label for="staticEmail" class=" col-form-label">Tendor sample Image</label>
                                     <div class = "">

                                         {{ $tendor->sample_image }}

                                  {{-- <img class="header-img" width = "150px" height = "100px" src="{{env('AD_IMG_URL').'upload_images/tendor_sample_image/'.$tendor->sample_image}}"> --}}
                                  <img class="header-img mt-1 mb-1" width = "150px" height = "100px" src=" {{env('IMG_URL').'upload_images/tendor_sample_image/'.$tendor->sample_image}}">
