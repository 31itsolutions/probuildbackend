...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{route('user_accounts')}}" >Users Accounts</a>
        <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Edit User Account</a>
    {{-- <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#">Edit Sub Categories</a>  --}}
    </h1>
        </div>    
                     ...
                     <form action="{{ route('update_customer',$user_account->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                <div class = "row m-1">
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "fname" value = "{{$user_account->name}} "required   class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "lname"  value = "{{$user_account->lname}}" required class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "email"  value = "{{$user_account->email}}" required class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
   ...
   <input id="phone"  value = "{{$user_account->number}}" name = "mobile" class = "form-control" type="tel">
   ...
   <span id="error-msg" class="hide">Invalid number</span>                                 
                    ...
                    <input type="file" name = "cu_profile" onChange="dragNdrop(event)"  ondragover="drag()" ondrop="drop()" id="uploadFile"  />
                     ...
                     <div class = "image_cu"  id="preview"></div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text"  name = "area" value = "{{$user_account->area}}" required class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "city"  value = "{{$user_account->city}}" required class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                              <div class = "row m-1">
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "province"  value = "{{$user_account->province}}" required class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "country"  value = "{{$user_account->country}}" required class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text"  name = "zip" value = "{{$user_account->zip}}"  required class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div> --}}
                                   </div>
