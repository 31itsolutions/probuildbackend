...
<div class="container">
    ...
    <div class = "back-option mt-1">     
        ...
        <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('privacy_policy') }}" >Privacy Policy</a>
            {{-- <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ url()->previous() }}" >Edit Advertisements Images</a>  --}}
            <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ url()->previous() }}" >Edit Privacy policy</a> 
        </h1>
            </div> 
...
@foreach($privacy as $child)

                <div class="mt-3">
                    <form action="{{ route('update_edited_privacy_policy',$child->id) }}" method="POST" >
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "title" value = "{{$child->title}}" class="form-control"  required id="exampleInputEmail1"  placeholder=" ">
                                  </div>
                            </div>
                        </div>
                        ...
                        <textarea class="form-control" name = "title_description"  id="exampleFormControlTextarea1" required rows="3">{{$child->title_description}}</textarea>
                        </div>
                            </div>
                        </div>
