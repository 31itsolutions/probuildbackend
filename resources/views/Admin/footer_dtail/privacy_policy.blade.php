...
<div class="container">
    ...
    <div class = "back-option mt-1">     
        ...
        <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('privacy_policy') }}" >Privacy policy</a>
        ...
        <div class="col-md-12 ">
            ...
            <div class="m-2">
                ...
                <div class="mt-1 view_edit r-0 b-3">
                                            ...
                                            <a href="{{route('edit_privacy_policy')}}"> <i class="fas fa-edit"></i> </a>
                ...
                <div class="mt-3">
                    <form action="{{ route('update_privacy_policy') }}" method="POST" >
                        @csrf
