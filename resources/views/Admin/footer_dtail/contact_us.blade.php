...
<div class="row">
    <div class = "back-option mt-1">     
        ...
        {{-- <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('advertisement') }}" >Advertisements Images</a> --}}
            ...
            <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Contact Us</a> 
        </h1>
            </div> 
...
<table class="table">
  ...
  <tbody>
           @foreach($contact_us as $key => $item)
  ...
  <div class="row">
   ...
   <div class="mx-auto mt-2" style="width: fit-content">
                {{ $contact_us->links('pagination::bootstrap-4') }}</div>
