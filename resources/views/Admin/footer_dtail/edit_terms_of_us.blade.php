...
<div class="container">
    ...
    <div class = "back-option mt-1">     
        ...
        <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('terms_of_use') }}" >Terms of use</a>
            {{-- <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ url()->previous() }}" >Edit Advertisements Images</a>  --}}
            <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ url()->previous() }}" >Edit Terms of use</a> 
        </h1>
            </div> 
...
@foreach($term as $child)
                ...
                <div class="mt-3">
                    <form action="{{ route('update_edited_terms_of_use',$child->id) }}" method="POST" >
                        @csrf
