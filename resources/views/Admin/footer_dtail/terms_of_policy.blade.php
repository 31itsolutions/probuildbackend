...
<div class="container">
    ...
    <div class = "back-option mt-1">     
        ...
        <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('terms_of_use') }}" >Terms of use</a>
        ...
        <div class="col-md-12 ">
            ...
            <div class="m-2">
                ...
                <div class="mt-1 view_edit r-0 b-3">
                                            ...
                                            <a href="{{route('edit_terms_of_use')}}"> <i class="fas fa-edit"></i> </a>
                ...
                <div class="mt-3">
                    <form action="{{ route('update_terms_of_use') }}" method="POST" >
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "title" class="form-control"  required id="exampleInputEmail1"  placeholder=" ">
                                  </div>
                            </div>
                        </div>
