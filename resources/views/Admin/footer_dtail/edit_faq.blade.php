...
<div class="container">
    ...
    <div class = "back-option mt-1">     
        ...
        <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('faq') }}" >FAQ</a>
            {{-- <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ url()->previous() }}" >Edit Advertisements Images</a>  --}}
            <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ url()->previous() }}" >Edit FAQ</a> 
        </h1>
            </div>
...
@foreach($faq as $child)

                <div class="mt-3">
                    <form action="{{ route('update_edited_faq',$child->id) }}" method="POST" >
                        @csrf
