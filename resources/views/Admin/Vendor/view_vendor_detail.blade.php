...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('vendor_accounts', $vendor_account) }}" >Vendor Accounts</a>
         <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="#" >Vendor Account </a>
        {{--<i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Edit Tendor Details</a> --}}
                          ...
                          <div class = "row">
                           ...
                           <div class = "mr-1 mb-1 update_status">
                             ...
                             <div class="pack-edit ml-2 mt-2">
                                ...
                                <p  style = "margin-top:6px; ">{{$vendor_account->email}}</p>
                                 ...
                                 @endif
                                     ...
                                     @if($plan_detail->package_type == "M")

                                     Monthly package

                                     @elseif ($plan_detail->package_type == "Y")
                                 ...
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px; ">{{$vendor_account->area}}</p>
                                 </div>
                                 </div>
                                   </div>
                              ...
                              <div class = "row mx-2 mt-1">
                                 ...
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px; ">{{$vendor_account->province}}</p>
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px; "> {{ $vendor_account->country }}</p>
                                 </div>
                                 </div>
                                   </div>
                            ...
                            <select name = "verified_vendor" class="form-control" readonly>
