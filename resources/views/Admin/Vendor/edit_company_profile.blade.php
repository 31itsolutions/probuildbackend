...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('vendor_accounts', $vendor_account) }}" >Vendor Accounts</a>
         ...
         <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ url()->previous() }}" >Company Details</a>
         <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Edit Company Details</a>
    </h1>
        </div>
                        ...
                        <div class = "row mt-1 ml-2">
                            ...
                            <div class = "row mt-1 mx-2 mb-2">
                                <div class = "col-sm-12">
                                      ...
                                      <div class="custom-file">
                                   <input type="file" class="custom-file-input" name ="business_logo" id="validatedCustomFile" >
                                      <label class="custom-file-label" for="validatedCustomFile">{{$business_id->business_logo}}</label>
                                   <div class="invalid-feedback">Example invalid custom file feedback</div>
                                   </div>
                                   </div>
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-12">
                            ...
                            <div class = "col-sm-12">
                                  ...
                                  <div class="custom-file">
                               <input type="file" class="custom-file-input" name ="business_image" id="validatedCustomFile" >

                                  <label class="custom-file-label" for="validatedCustomFile">{{$business_id->business_image}}</label>
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
  ...
  <div class="pack-head   ml-2">
             ...
             <div class="form-group row mx-1" >
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "mobile" value = "{{$business_id->mobile_no}}"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
...
<form action = "{{ route('update_product_admin', $item->id) }}" method = "POST" enctype="multipart/form-data">
    @csrf
             ...
             <div class="form-group row mx-1" >
                        ...
                        <div class = "col-md-12">
                            ...
                            <div class = "col-sm-12">
                             ...
                             <label for="staticEmail" class="col-form-label">Product image</label>

                                  <div class="custom-file">
                               <input type="file" class="custom-file-input" name ="product_image" id="validatedCustomFile" >

                                  <label class="custom-file-label" for="validatedCustomFile">Choose Docs...</label>
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
                                                                  <small id="emailHelp" class="form-text text-muted">Image size : 48X48</small>

                               </div>


                                    <img class="header-img mt-2" width = "150px" height = "100px" src="{{env('IMG_URL').'upload_images/product_image/'.$item->product_image}}">
...
<form action = "{{ route('add_more_product_admin', $business_id->id) }}" method = "POST" enctype="multipart/form-data">
    @csrf
                            ...
                            <div class = "row ml-2">
                             <div class = "col-md-6">
                               ...
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
                                ...
                                <img class="header-img ml-3" width = "150px" height = "100px" src="{{env('IMG_URL').'upload_images/gallery_image/'.$item->gallery_image}}">
