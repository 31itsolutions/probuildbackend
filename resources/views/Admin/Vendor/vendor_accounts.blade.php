...
<div class="row">
    ...
    <div class="back-option mt-1">
        <h1> <i class="fas fa-home text-light"></i> <i class="fas fa-chevron-right text-light"></i> <a
                class="text-light" href="{{ route('admin.home') }}">Home</a>
            <i class="fas fa-chevron-right text-light"></i> <a class="active_url"
                href="{{ route('vendor_accounts') }}">Vendors Accounts</a>
                ...
                <tbody>
                    ...
                    @foreach ($vendor_accounts as $key => $item)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="custom-control custom-switch custom-switch-glow custom-control-inline">
                                    <input type="checkbox" class="custom-control-input"
                                        {{ $item->account_status == 1 ? 'checked' : '' }}
                                        value="{{ $item->id }}"
                                        onchange="change_status(this.value, 'vendors', '#customSwitchGlow{{ $key }}', 'id');"
                            ...
                            <td>
                                <a class="eye_icon" href="{{ route('vendor_account', $item->id) }}">
...
<div class="customizer d-none d-md-block"><a class="customizer-toggle" href="javascript:void(0);"><i
    ...
    <div class="customizer-content p-2">
        ...
        <div class="footer-type d-flex justify-content-start">
            ...
            <!-- Card Shadow Starts-->
            <div class="
                            card-shadow d-flex justify-content-between align-items-center py-25">
