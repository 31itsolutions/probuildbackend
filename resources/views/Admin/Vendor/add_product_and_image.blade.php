...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('company_profile', $vendor_account) }}" >Company Profile</a>
        ...
        <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Add Product Details</a> 
    </h1>
        </div> 
...
<form action = "{{ route('add_product_admin', $vendor_account->id) }}" method = "POST" enctype="multipart/form-data">
    @csrf
             ...
             <div class="form-group row mx-1" >
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "product_price_from"  class="form-control" id="staticEmail" required>
                                 </div>
                                 </div>
                                 </div>
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text"  name = "product_price_to"   class="form-control" id="staticEmail" required>
                                 </div>
                                 </div>
                               ...
                               <input type="file" class="custom-file-input" name ="product_image" id="validatedCustomFile" required >
                        ...
                        <div class = "col-md-12">
                                 ...
                                 <div class="">
                                 <input type="text" style = "height:70px;" name = "product_description"   class="form-control" required id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
...
<div class  = "border mt-1 mb-2">
    ...
    <div class="pack-head   ml-2 mb-2">
                  ...
                  <div class = "col-md-5">
                               ...
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
                                 <small id="emailHelp" class="form-text text-muted">Maximum Limit 10 Images</small>
