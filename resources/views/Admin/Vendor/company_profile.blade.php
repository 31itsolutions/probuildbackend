...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('vendor_accounts', $vendor_account) }}" >Vendor Accounts</a>
         ...
         <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Company Details</a>
    </h1>
        </div>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            ...
                                            value="{{$item->id}}"  onchange="change_featured_status(this.value, 'businesses', '#customSwitchGlow1{{$key}}', 'id');" id="customSwitchGlow1{{$key}}" >
                                        ...
                                        <td><a class = "eye_icon" href="{{route('business_detail', $item->id)}}"><i class="fa fa-eye " aria-hidden="true"></i></a>
                                            <a class = "edit_icon" href="{{route('edit_company_profile',$item->id)}}"><i class="fas fa-edit "></i></a>
                                        ...
                                        <a class=" delete_icon" onclick="if (confirm('Are you sure want to delete ?')){
 ...
 {{--------------------------------------------------------  --}}
  <script>
      ...
      var featured_business = 0;
        if($(check).is(':checked')){
            var featured_business = 1;
        }
      $.ajax({
