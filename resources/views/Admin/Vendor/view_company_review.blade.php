...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('vendor_accounts', $vendor_account) }}" >Vendor Accounts</a>
         ...
         <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ url()->previous() }}" >Business Details</a>
         <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Business Review</a>
    </h1>
        </div>
    ...
    <tr>
      ...
      <td>
         ...
         <div class="custom-control custom-switch custom-switch-glow custom-control-inline">
                                            ...
                                            value="{{$item->id}}"  onchange="change_status(this.value, 'reviews', '#customSwitchGlow{{$key}}', 'id');" id="customSwitchGlow{{$key}}" >
