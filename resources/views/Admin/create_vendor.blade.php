...
@include('Admin.admin_layout.header')
    ...
    <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Create Vendors</a>
                ...
                <div class="mt-3">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fname" id="exampleInputEmail1"  placeholder=" " required>
                                  </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lname" id="exampleInputEmail1"  placeholder="" required>
                                  </div>           
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"  class="form-control" name="mobile" id="exampleInputEmail1"  placeholder="" required>
                                  </div>                               
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="password"  class="form-control" name="pwd" id="exampleInputEmail1"  placeholder="" required>
                      </div>
                      </div>
                      <div class = "col-sm-6">
                        ...
                        <input type="text"  class="form-control" name="area" id="exampleInputEmail1"  placeholder="" required>
                      </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="city" id="exampleInputEmail1"  placeholder="" required>
                      </div>
                      </div>
                      <div class = "col-sm-6">
                        ...
                        <input type="text"  class="form-control" name="province" id="exampleInputEmail1"  placeholder="" required>
                      </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="country" id="exampleInputEmail1"  placeholder="" required>
                      </div>
                      </div>
                      {{-- <div class = "col-sm-6">
                        ...
                        <input type="text"  class="form-control" name="zip" id="exampleInputEmail1"  placeholder="" required>
                      </div>
                    ...
                    <select name = "package_status" class="form-control" required>
                    <option>choose package..</option>
