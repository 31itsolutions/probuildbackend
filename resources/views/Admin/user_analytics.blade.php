...
<div class = "back-option mt-1">     
    ...
    {{-- <i class="fas fa-chevron-right text-light"></i> <a class="text-light" href="{{ route('about_us') }}" >About Us</a> --}}
        <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="#" >Users Analytics</a> 
        {{-- <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ url()->previous() }}" >Edit About Us</a>  --}}
    </h1>
        </div> 


<div class = " mt-2 rounded card mt-1">
                    ...
                    <div class = " col-md-4 ">
                    <div class = "border_one noview number_of ">
                    ...
                    <div class = " col-md-4 ">
                        <div class = "border_one vendorview number_of ">
    
                        <i class="bx bx-user "></i>
    
                        <h1>Number of Active Vendors</h1>
                       ...
                       <div class = " col-md-4 ">
                       <div class = "border_one cuview number_of">
...
<div class = " admin_home_bottom mx-2 number_of bg_card  row mt-3 mb-2">
...
<div class="  m-2 mb-5 text-center">
             ...
             <p>Total Number of active tendors </p>

                          <h1 class = "b_count">{{$tendor_count}}</h1>
</div>
</div>
