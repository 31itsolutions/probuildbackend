                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="ml-5 pl-4">
                                                            <select name="package_type"  id="validationCustom03" onchange="ChangecatListPackage()" required
                                                                ...
                                                                @if($edit_package->package_type == "M")
                                                                <option  value="M">Monthly</option>
                                                                @elseif($edit_package->package_type == "Y")
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="ml-4 pl-4">
                                                            <select name="g_type"  id="g_type" onchange="ChangecatList()" required
                                                                ...
                                                                @if($edit_package->goss_type == "D")
                                                                <option value="D">In Days</option>
                                                                @elseif($edit_package->gross_type == "M")
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-inline">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="ml-2 pl-5">
                                                            <input class="form-control ml-1" value = "{{$edit_package->price}}" type="text" name="price" id="inputState">                                                           
                                                            </small>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="ml-5 pl-5 ">
                                                            <select name="validity" height="40px"  id="val"
                                                                ...
                                                                <option>{{$edit_package->validity}}</option>
                                                                                          </select>
                                                            </small>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="ml-5 pl-5 ">
                                                            <select name="g_period" height="40px"  id="g_value"
                                                                class="form-control ml-1 ">
                                                                @if ($edit_package->gross_type == "M")
                                                                <option value = "{{$edit_package->gross_period}}">{{$edit_package->gross_period}} Months</option>
                                                                @elseif($edit_package->gross_type == "Y")
                                                                <option value = "{{$edit_package->gross_period}}">{{$edit_package->gross_period}} Years</option>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-inline">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="ml-0 pl-5">
                                                            <input class="form-control ml-1" value = "{{$edit_package->selling_price}}" type="text" name="selling_price" id="inputState">                                                           
                                                            </small>
                                                        </div>
                                                    </div>
                                                </div>
...
var catAndAct = {};
catAndAct['M'] = ['0', '1 Months ', '2 Months  ', '3 Months', '4 Months ', '5 Months', '6 Months', '7 Months', '8 Months', '9 Months', '10 Months', '11 Months'];
catAndAct['Y'] = ['0', '1 Year', '2 Years', '3 Years', '4 Years', '5 Years'];
