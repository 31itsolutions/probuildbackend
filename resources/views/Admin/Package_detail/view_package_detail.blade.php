                              ...
                              <div class = "row m-1">
                                 ...
                                 <input type="text" readonly value = "{{$view_package->probuild_verify}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                  ...
                                  <div class="col-sm-6 ">
                                            ...
                                            <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Tendor Board</label>
                                 <div class="col-sm-6">
                                 ...
                                 <input type="text" readonly value = "{{$view_package->price}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                      ...
                                      <div class="col-sm-6 ">
                                            ...
                                            <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Gross Type</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->g_type}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="col-sm-6 ">
                                            ...
                                            <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Gross Period</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->g_period}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->selling_price}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
