...
@include('Admin.admin_layout.header')
 ...
 <h1> <i class="fas fa-home text-light"></i>  <i class="fas fa-chevron-right text-light"></i> <a class="active_url" href="{{ route('admin.home') }}">Home</a> 
         </h1>
...
<div class = "card mt-1 rounded bg_admin_home">
                    ...
                    <div class = " col-md-6 ">
                    <div class = "border for_user number_of">
                    ...
                    <h2>{{$customer_count}}</h2>
                       ...
                       <div class = " col-md-6 ">
                       <div class = "border for_vendor number_of">

                       <i class="bx bx-user "></i>
                         <h1>Number of Vendors</h1>
<h2>{{$vendor_count}}</h2>
